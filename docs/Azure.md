...
![Screen shot of output from kubectl get services malcolm namespace command in Cloud Shell](images/screenshots/Azure_Cloud_Shell_kubectl_get_services_malcolm_command.png)
...
```
![Screen shot of the Malcolm dashboard page in a browser](images/screenshots/Azure_Cloud_Shell_helm_uninstall_malcolm_command.png)
...
```
![Screen shot of the Malcolm dashboard page in a browser](images/screenshots/Azure_Cloud_Shell_delete_namespace_command.png)
...
![Screen shot of the Malcolm dashboard page in a browser](images/screenshots/Azure_Cloud_Shell_delete_cluster_command.png)
...
![Screen shot of the Malcolm dashboard page in a browser](images/screenshots/Azure_Cloud_Shell_delete_group_command.png)
